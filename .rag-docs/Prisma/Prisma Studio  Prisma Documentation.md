...
## Prerequisites[](https://www.prisma.io/docs/orm/tools/prisma-studio#prerequisites "Direct link to Prerequisites")

Prisma Studio is a standalone tool that only requires a database connection. You have two options:

### Option 1: Use with any database (no Prisma project required)[](https://www.prisma.io/docs/orm/tools/prisma-studio#option-1-use-with-any-database-no-prisma-project-required "Direct link to Option 1: Use with any database (no Prisma project required)")
...
### Option 2: Use with a Prisma ORM project[](https://www.prisma.io/docs/orm/tools/prisma-studio#option-2-use-with-a-prisma-orm-project "Direct link to Option 2: Use with a Prisma ORM project")
...
## Getting started[](https://www.prisma.io/docs/orm/tools/prisma-studio#getting-started "Direct link to Getting started")

### Standalone usage (without Prisma ORM)[](https://www.prisma.io/docs/orm/tools/prisma-studio#standalone-usage-without-prisma-orm "Direct link to Standalone usage (without Prisma ORM)")
...
### With a Prisma ORM project[](https://www.prisma.io/docs/orm/tools/prisma-studio#with-a-prisma-orm-project "Direct link to With a Prisma ORM project")
...
## Core features[](https://www.prisma.io/docs/orm/tools/prisma-studio#core-features "Direct link to Core features")

Prisma Studio provides several key capabilities for working with your database:

### Browse your data[](https://www.prisma.io/docs/orm/tools/prisma-studio#browse-your-data "Direct link to Browse your data")
...
### View and edit records[](https://www.prisma.io/docs/orm/tools/prisma-studio#view-and-edit-records "Direct link to View and edit records")
...
### Add new records[](https://www.prisma.io/docs/orm/tools/prisma-studio#add-new-records "Direct link to Add new records")
...
### Delete records[](https://www.prisma.io/docs/orm/tools/prisma-studio#delete-records "Direct link to Delete records")
...
### Filter and search[](https://www.prisma.io/docs/orm/tools/prisma-studio#filter-and-search "Direct link to Filter and search")
...
### Control visibility[](https://www.prisma.io/docs/orm/tools/prisma-studio#control-visibility "Direct link to Control visibility")
...
### Keyboard shortcuts[](https://www.prisma.io/docs/orm/tools/prisma-studio#keyboard-shortcuts "Direct link to Keyboard shortcuts")

Studio supports keyboard shortcuts for common operations. Press Cmd+/ (macOS) or Ctrl+/ (Windows) to view all available shortcuts.

## Understanding data types[](https://www.prisma.io/docs/orm/tools/prisma-studio#understanding-data-types "Direct link to Understanding data types")
...
## Working with relations[](https://www.prisma.io/docs/orm/tools/prisma-studio#working-with-relations "Direct link to Working with relations")
...
## Databases supported by Prisma Studio[](https://www.prisma.io/docs/orm/tools/prisma-studio#databases-supported-by-prisma-studio "Direct link to Databases supported by Prisma Studio")

Prisma Studio currently supports the following databases: PostgreSQL, MySQL, and SQLite.

### SQLite requirements for Prisma Studio[](https://www.prisma.io/docs/orm/tools/prisma-studio#sqlite-requirements-for-prisma-studio "Direct link to SQLite requirements for Prisma Studio")
...
### Databases not yet supported[](https://www.prisma.io/docs/orm/tools/prisma-studio#databases-not-yet-supported "Direct link to Databases not yet supported")
...
### PostgreSQL: "unrecognized configuration parameter 'schema'" error[](https://www.prisma.io/docs/orm/tools/prisma-studio#postgresql-unrecognized-configuration-parameter-schema-error "Direct link to PostgreSQL: "unrecognized configuration parameter 'schema'" error")
...
```ruby
# ❌ This will cause an errorpostgresql://user:password@host:port/database?schema=my_schema# ✅ Use this instead  postgresql://user:password@host:port/database?options=-c%20search_path%3Dmy_schema
```
