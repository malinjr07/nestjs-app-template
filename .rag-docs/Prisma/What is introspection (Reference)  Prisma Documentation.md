...
Introspection is often used to generate an _initial_ version of the data model when [adding Prisma ORM to an existing project](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/postgresql).
...
![Introspect your database with Prisma](https://www.prisma.io/docs/assets/images/prisma-db-pull-generate-schema-e54e9643a3888cb5819a9863fad8b40d.png)
...
![Introspect workflow](https://www.prisma.io/docs/assets/images/prisma-evolve-app-workflow-5b7da5479f73827d61225528a63f5d68.png)
...
```graphql
$ npx prisma generateError: Schema parsingerror: The model "User" cannot be defined because a model with that name already exists.  -->  schema.prisma:17   |16 | }17 | model User {   |Validation Error Count: 1
```
