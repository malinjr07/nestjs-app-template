...
#### Use with Express[#](https://docs.nestjs.com/faq/raw-body#use-with-express)
...
#### Registering a different parser[#](https://docs.nestjs.com/faq/raw-body#registering-a-different-parser)
...
> **Warning** Ensure that you are providing the correct application type to the `NestFactory.create` call. For Express applications, the correct type is `NestExpressApplication`. Otherwise the `.useBodyParser` method will not be found.

#### Body parser size limit[#](https://docs.nestjs.com/faq/raw-body#body-parser-size-limit)
...
#### Use with Fastify[#](https://docs.nestjs.com/faq/raw-body#use-with-fastify)
...
#### Registering a different parser[#](https://docs.nestjs.com/faq/raw-body#registering-a-different-parser-1)
...
#### Body parser size limit[#](https://docs.nestjs.com/faq/raw-body#body-parser-size-limit-1)
