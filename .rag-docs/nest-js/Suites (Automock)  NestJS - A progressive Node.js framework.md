...
For more information on module-based testing, see the [testing fundamentals](https://docs.nestjs.com/fundamentals/testing) chapter.

> **Note**`Suites` is a third-party package and is not maintained by the NestJS core team. Please report any issues to the [appropriate repository](https://github.com/suites-dev/suites).

#### Getting started[#](https://docs.nestjs.com/recipes/suites#getting-started)
...
#### Install Suites[#](https://docs.nestjs.com/recipes/suites#install-suites)
...
#### Set up type definitions[#](https://docs.nestjs.com/recipes/suites#set-up-type-definitions)
...
#### Create a sample service[#](https://docs.nestjs.com/recipes/suites#create-a-sample-service)
...
#### Write a unit test[#](https://docs.nestjs.com/recipes/suites#write-a-unit-test)
...
#### Pre-compile mock configuration[#](https://docs.nestjs.com/recipes/suites#pre-compile-mock-configuration)
...
#### Testing with real dependencies[#](https://docs.nestjs.com/recipes/suites#testing-with-real-dependencies)
...
#### Token-based dependencies[#](https://docs.nestjs.com/recipes/suites#token-based-dependencies)
...
#### Using mock() and stub() directly[#](https://docs.nestjs.com/recipes/suites#using-mock-and-stub-directly)
...
> **Hint** The `mock()` function is an alternative to `createMock` from `@golevelup/ts-jest`. Both create typed mock objects. See the [testing fundamentals](https://docs.nestjs.com/fundamentals/testing#auto-mocking) chapter for more on `createMock`.

#### Summary[#](https://docs.nestjs.com/recipes/suites#summary)
