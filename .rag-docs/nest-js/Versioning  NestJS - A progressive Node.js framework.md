...
> **Notice** With URI Versioning the version will be automatically added to the URI after the [global path prefix](https://docs.nestjs.com/techniques/faq/global-prefix) (if one exists), and before any controller or route paths.
