-   [Request lifecycle](https://docs.nestjs.com/faq/request-lifecycle#request-lifecycle)
-   [Middleware](https://docs.nestjs.com/faq/request-lifecycle#middleware)
-   [Guards](https://docs.nestjs.com/faq/request-lifecycle#guards)
-   [Interceptors](https://docs.nestjs.com/faq/request-lifecycle#interceptors)
-   [Pipes](https://docs.nestjs.com/faq/request-lifecycle#pipes)
-   [Filters](https://docs.nestjs.com/faq/request-lifecycle#filters)
