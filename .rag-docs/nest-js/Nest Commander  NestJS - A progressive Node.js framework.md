...
#### Installation[#](https://docs.nestjs.com/recipes/nest-commander#installation)
...
#### A Command file[#](https://docs.nestjs.com/recipes/nest-commander#a-command-file)
...
#### Running the Command[#](https://docs.nestjs.com/recipes/nest-commander#running-the-command)
...
#### Testing[#](https://docs.nestjs.com/recipes/nest-commander#testing)
...
#### Putting it all together[#](https://docs.nestjs.com/recipes/nest-commander#putting-it-all-together)
...
#### More Information[#](https://docs.nestjs.com/recipes/nest-commander#more-information)
