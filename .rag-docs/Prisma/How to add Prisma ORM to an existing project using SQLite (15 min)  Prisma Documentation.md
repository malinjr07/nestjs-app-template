...
## Prerequisites[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#prerequisites "Direct link to Prerequisites")
...
## 1\. Set up Prisma ORM[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#1-set-up-prisma-orm "Direct link to 1. Set up Prisma ORM")

Navigate to your existing project directory and install the required dependencies:

```bash
npm install prisma @types/node @types/better-sqlite3 --save-devnpm install @prisma/client @prisma/adapter-better-sqlite3 dotenv
```
...
## 2\. Initialize Prisma ORM[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#2-initialize-prisma-orm "Direct link to 2. Initialize Prisma ORM")
...
## 3\. Connect your database[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#3-connect-your-database "Direct link to 3. Connect your database")
...
## 4\. Introspect your database[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#4-introspect-your-database "Direct link to 4. Introspect your database")
...
## 5\. Baseline your database[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#5-baseline-your-database "Direct link to 5. Baseline your database")
...
## 6\. Generate Prisma ORM types[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#6-generate-prisma-orm-types "Direct link to 6. Generate Prisma ORM types")
...
## 7\. Instantiate Prisma Client[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#7-instantiate-prisma-client "Direct link to 7. Instantiate Prisma Client")
...
## 8\. Query your database[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#8-query-your-database "Direct link to 8. Query your database")
...
## 9\. Evolve your schema[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#9-evolve-your-schema "Direct link to 9. Evolve your schema")

To make changes to your database schema:

### 9.1. Update your Prisma schema file[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#91-update-your-prisma-schema-file "Direct link to 9.1. Update your Prisma schema file")
...
### 9.2. Create and apply a migration:[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#92-create-and-apply-a-migration "Direct link to 9.2. Create and apply a migration:")
...
## 10\. Explore your data with Prisma Studio[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#10-explore-your-data-with-prisma-studio "Direct link to 10. Explore your data with Prisma Studio")
...
## Next steps[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#next-steps "Direct link to Next steps")
...
## More info[](https://www.prisma.io/docs/getting-started/prisma-orm/add-to-existing-project/sqlite#more-info "Direct link to More info")
