...
#### Multiple simultaneous servers[#](https://docs.nestjs.com/faq/multiple-servers#multiple-simultaneous-servers)
...
> **Warning** This recipe does not work with [GraphQL Subscriptions](https://docs.nestjs.com/graphql/subscriptions).