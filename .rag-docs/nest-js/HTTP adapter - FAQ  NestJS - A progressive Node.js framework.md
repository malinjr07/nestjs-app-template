...
#### Outside application context strategy[#](https://docs.nestjs.com/faq/http-adapter#outside-application-context-strategy)
...
#### As injectable[#](https://docs.nestjs.com/faq/http-adapter#as-injectable)
...
> **Hint** The `HttpAdapterHost` is imported from the `@nestjs/core` package.
...
#### Listening event[#](https://docs.nestjs.com/faq/http-adapter#listening-event)
